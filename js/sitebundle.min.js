...
function throttle(n, t) {
    ...
    return function () {
        ...
        i != null ? (window.clearTimeout(i),
            r = !0) : n.apply(u, f);
        i = window.setTimeout(e, t)
    }
}
function setLoggedIn(n) {
    n && ($(document.documentElement).addClass("ownerrez-loggedin"),
        $(".show-if-login").fadeIn(100))
}
!function (n, t) {
    "use strict";
...
!function (n) {
    "object" == typeof module && module.exports ? module.exports = n() : window.intlTelInput = n()
}(function (n) {
    "use strict";
    return function () {
        function l(n) {
            for (var i, r, t = 1; t < arguments.length; t++)
                i = null != arguments[t] ? Object(arguments[t]) : {},
                    r = Object.keys(i),
                    "function" == typeof Object.getOwnPropertySymbols && r.push.apply(r, Object.getOwnPropertySymbols(i).filter(function (n) {
        ...
        function s(n, t) {
            for (var i, r = 0; r < t.length; r++)
                i = t[r],
                    ...
                    Object.defineProperty(n, h(i.key), i)
        }
        function y(n, t, i) {
        ...
        function p(t, i) {
            ...
            if ("object" != typeof t || null === t)
                return t;
            if (r = t[Symbol.toPrimitive],
                r !== n) {
                if (u = r.call(t, i || "default"),
                    "object" != typeof u)
                    return u;
        ...
        var w = 0
            ...
            , f = function (n) {
                e(window.intlTelInputGlobals.instances, function (t) {
                    window.intlTelInputGlobals.instances[t][n]()
                })
            }
            , k = function () {
                function i(n, t) {
                ...
                return y(i, [{
                    ...
                    value: function () {
                        ...
                        t = this.d.allowDropdown && !this.d.separateDialCode;
                        (!this.d.showFlags && t && (this.d.showFlags = !0),
                            ...
                            "undefined" != typeof Promise) ? (i = new Promise(function (t, i) {
                                n.h = t;
                                n.i = i
                            }
                            ),
                                ...
                                this.promise = Promise.all([i, r])) : (this.h = this.i = function () { }
                                    ,
                    ...
                    value: function (t, i, r) {
                        var u, f;
                        for (i.length > this.countryCodeMaxLen && (this.countryCodeMaxLen = i.length),
                            this.q.hasOwnProperty(i) || (this.q[i] = []),
                            u = 0; u < this.q[i].length; u++)
                            if (this.q[i][u] === t)
                                return;
                    ...
                    value: function () {
                        var n, i;
                        this.d.onlyCountries.length ? (n = this.d.onlyCountries.map(function (n) {
                            return n.toLowerCase()
                        }),
                            this.p = t.filter(function (t) {
                                return n.indexOf(t.iso2) > -1
                            })) : this.d.excludeCountries.length ? (i = this.d.excludeCountries.map(function (n) {
                                return n.toLowerCase()
                            }),
                                this.p = t.filter(function (n) {
                                    return -1 === i.indexOf(n.iso2)
                                })) : this.p = t
                    }
                }, {
                    key: "_d0",
                    value: function () {
                        for (var t, n = 0; n < this.p.length; n++)
                            t = this.p[n].iso2.toLowerCase(),
                                this.d.localizedCountries.hasOwnProperty(t) && (this.p[n].name = this.d.localizedCountries[t])
                    }
                }, {
                    key: "_d1",
                    value: function (n, t) {
                    ...
                    value: function () {
                        ...
                        for (this.countryCodeMaxLen = 0,
                            this.dialCodes = {},
                            this.q = {},
                            i = 0; i < this.p.length; i++)
                            t = this.p[i],
                        ...
                        for (r = 0; r < this.p.length; r++)
                            if (n = this.p[r],
                                n.areaCodes)
                                for (s = this.q[n.dialCode][0],
                                    u = 0; u < n.areaCodes.length; u++) {
                                    for (f = n.areaCodes[u],
                                        e = 1; e < f.length; e++)
                                        o = n.dialCode + f.substr(0, e),
                                            this._c(s, o),
                                            this._c(n.iso2, o);
                    ...
                    value: function () {
                        var n, i, t;
                        for (this.preferredCountries = [],
                            n = 0; n < this.d.preferredCountries.length; n++)
                            i = this.d.preferredCountries[n].toLowerCase(),
                                t = this._y(i, !1, !0),
                    ...
                    value: function () {
                        ...
                        var n = this.d
                            , r = n.allowDropdown
                            , e = n.separateDialCode
                            , o = n.showFlags
                            , c = n.customContainer
                            , a = n.hiddenInput
                            , v = n.dropdownContainer
                            , t = "iti";
                        r && (t += " iti--allow-dropdown");
                        e && (t += " iti--separate-dial-code");
                        o && (t += " iti--show-flags");
                        c && (t += " ".concat(c));
                        i = this._e2("div", {
                            "class": t
                        ...
                        s = r || o || e;
                        (s && (this.k = this._e2("div", {
                            "class": "iti__flag-container"
                        }, i)),
                            i.appendChild(this.a),
                            s && (this.selectedFlag = this._e2("div", l({
                            ...
                            o && (this.l = this._e2("div", {
                                "class": "iti__flag"
                            }, this.selectedFlag)),
                            this.selectedFlag && this.a.disabled && this.selectedFlag.setAttribute("aria-disabled", "true"),
                            e && (this.t = this._e2("div", {
                                "class": "iti__selected-dial-code"
                            }, this.selectedFlag)),
                            r && (this.a.disabled || this.selectedFlag.setAttribute("tabindex", "0"),
                                this.u = this._e2("div", {
                                    "class": "iti__arrow"
                                }, this.selectedFlag),
                                this.m = this._e2("ul", {
                            ...
                            a) && (u = a,
                                ...
                                f && (h = f.lastIndexOf("["),
                                    -1 !== h && (u = "".concat(f.substr(0, h), "[").concat(u, "]"))),
                    ...
                    key: "_g",
                    value: function (n, t, i) {
                        for (var u, e, r = "", f = 0; f < n.length; f++)
                            u = n[f],
                                e = i ? "-preferred" : "",
                                r += "<li class='iti__country ".concat(t, "' tabIndex='-1' id='iti-").concat(this.id, "__item-").concat(u.iso2).concat(e, "' role='option' data-dial-code='").concat(u.dialCode, "' data-country-code='").concat(u.iso2, "' aria-selected='false'>"),
                                this.d.showFlags && (r += "<div class='iti__flag-box'><div class='iti__flag iti__".concat(u.iso2, "'><\/div><\/div>")),
                                r += "<span class='iti__country-name'>".concat(u.name, "<\/span>"),
                                r += "<span class='iti__dial-code'>+".concat(u.dialCode, "<\/span>"),
                                r += "<\/li>";
                    ...
                    value: function () {
                        var t = this.a.getAttribute("value")
                            , i = this.a.value
                            , o = t && "+" === t.charAt(0) && (!i || "+" !== i.charAt(0))
                            , n = o ? t : i
                            , u = this._5(n)
                            , f = this._w(n)
                            , e = this.d
                            , r = e.initialCountry
                            , s = e.autoInsertDialCode;
                        u && !f ? this._v(n) : "auto" !== r && (r ? this._z(r.toLowerCase()) : u && f ? this._z("us") : (this.j = this.preferredCountries.length ? this.preferredCountries[0].iso2 : this.p[0].iso2,
                            n || this._z(this.j)),
                            !n && s && (this.a.value = "+".concat(this.s.dialCode)));
                        n && this._u(n)
                    }
                }, {
                    key: "_i",
                    ...
                    key: "_i1",
                    value: function () {
                        for (var n = this.a; n && "LABEL" !== n.tagName;)
                            n = n.parentNode;
                        return n
                    }
                }, {
                    ...
                    value: function () {
                        var n = this, t;
                        this._a9 = function (t) {
                            n.m.classList.contains("iti__hide") ? n.a.focus() : t.preventDefault()
                        }
                            ;
                        t = this._i1();
                        t && t.addEventListener("click", this._a9);
                        this._a10 = function () {
                            !n.m.classList.contains("iti__hide") || n.a.disabled || n.a.readOnly || n._n()
                        }
                            ;
                        this.selectedFlag.addEventListener("click", this._a10);
                        this._a11 = function (t) {
                            n.m.classList.contains("iti__hide") && -1 !== ["ArrowUp", "Up", "ArrowDown", "Down", " ", "Enter"].indexOf(t.key) && (t.preventDefault(),
                                t.stopPropagation(),
                                n._n());
                            "Tab" === t.key && n._2()
                        }
                    ...
                    value: function () {
                        ...
                        this.d.utilsScript && !window.intlTelInputUtils ? window.intlTelInputGlobals.documentReady() ? window.intlTelInputGlobals.loadUtils(this.d.utilsScript) : window.addEventListener("load", function () {
                            window.intlTelInputGlobals.loadUtils(n.d.utilsScript)
                        }) : this.i0();
                    ...
                    value: function () {
                        window.intlTelInputGlobals.autoCountry ? this.handleAutoCountry() : window.intlTelInputGlobals.startedLoadingAutoCountry || (window.intlTelInputGlobals.startedLoadingAutoCountry = !0,
                            "function" == typeof this.d.geoIpLookup && this.d.geoIpLookup(function (n) {
                    ...
                    value: function () {
                        var n = this;
                        this._a12 = function () {
                            n._v(n.a.value) && n._m2CountryChange()
                        }
                            ;
                    ...
                    value: function (n) {
                        ...
                        return t && n.length > t ? n.substr(0, t) : n
                    }
                }, {
                    key: "_l",
                    value: function () {
                    ...
                    key: "_n2",
                    value: function (n, t, i) {
                        i && !n.classList.contains(t) ? n.classList.add(t) : !i && n.classList.contains(t) && n.classList.remove(t)
                    }
                }, {
                    key: "_o",
                    value: function () {
                        ...
                        if (this.d.dropdownContainer && this.d.dropdownContainer.appendChild(this.dropdown),
                            ...
                            var i = this.a.getBoundingClientRect()
                                ...
                                , f = t - r > n;
                            (this._n2(this.m, "iti__country-list--dropup", !u && f),
                                this.d.dropdownContainer) && (e = !u && f ? 0 : this.a.offsetHeight,
                                    this.dropdown.style.top = "".concat(t + e, "px"),
                    ...
                    key: "_o2",
                    value: function (n) {
                        for (var t = n; t && t !== this.m && !t.classList.contains("iti__country");)
                            t = t.parentNode;
                    ...
                    value: function () {
                        ...
                        this._a3 = function (r) {
                            r.preventDefault();
                            "ArrowUp" === r.key || "Up" === r.key || "ArrowDown" === r.key || "Down" === r.key ? n._q(r.key) : "Enter" === r.key ? n._r() : "Escape" === r.key ? n._2() : /^[a-zA-ZÀ-ÿа-яА-Я ]$/.test(r.key) && (i && clearTimeout(i),
                                t += r.key.toLowerCase(),
                                n._s(t),
                    ...
                    value: function (n) {
                        ...
                        t && (t.classList.contains("iti__divider") && (t = "ArrowUp" === n || "Up" === n ? t.previousElementSibling : t.nextElementSibling),
                            this._x(t, !0))
                    }
                }, {
                    key: "_r",
                    ...
                    key: "_t",
                    value: function (n, t) {
                        return n.substr(0, t.length).toLowerCase() === t
                    }
                }, {
                    key: "_u",
                    value: function (n) {
                        ...
                        if (this.d.formatOnDisplay && window.intlTelInputUtils && this.s) {
                            var r = this.d.nationalMode || "+" !== t.charAt(0) && !this.d.separateDialCode
                    ...
                    key: "_v",
                    value: function (n) {
                        var t = n, f = this.s.dialCode, h = "1" === f, r, s, u;
                        t && h && "+" !== t.charAt(0) && ("1" !== t.charAt(0) && (t = "1".concat(t)),
                            t = "+".concat(t));
                        ...
                        var e = this._5(t, !0)
                            ...
                            , i = null;
                        if (e) {
                            if (r = this.q[this._m(e)],
                                s = -1 !== r.indexOf(this.s.iso2) && o.length <= e.length - 1,
                                !("1" === f && this._w(o)) && !s)
                            ...
                            "+" === t.charAt(0) && o.length ? i = "" : t && "+" !== t || (i = this.j);
                    ...
                    value: function (n) {
                        var t = this._m(n), i;
                        return "1" === t.charAt(0) ? (i = t.substr(1, 3),
                            -1 !== b.indexOf(i)) : !1
                    }
                }, {
                    key: "_x",
                    ...
                    key: "_z",
                    value: function (n) {
                        var e = this.s.iso2 ? this.s : {}, r, u, f, t, i;
                        return (this.s = n ? this._y(n, !1, !1) : {},
                            this.s.iso2 && (this.j = this.s.iso2),
                            this.d.showFlags && this.l.setAttribute("class", "iti__flag iti__".concat(n)),
                            this.selectedFlag) && (r = n ? "".concat(this.s.name, ": +").concat(this.s.dialCode) : "Unknown",
                                this.selectedFlag.setAttribute("title", r)),
                            this.d.separateDialCode && (u = this.s.dialCode ? "+".concat(this.s.dialCode) : "",
                                this.t.innerHTML = u,
                                f = this.selectedFlag.offsetWidth || this._z2(),
                                this.a.style.paddingLeft = "".concat(f + 6, "px")),
                            (this._0(),
                                this.d.allowDropdown) && (t = this.b,
                                    (t && (t.classList.remove("iti__active"),
                                        t.setAttribute("aria-selected", "false")),
                                        n) && (i = this.m.querySelector("#iti-".concat(this.id, "__item-").concat(n, "-preferred")) || this.m.querySelector("#iti-".concat(this.id, "__item-").concat(n)),
                    ...
                    key: "_z2",
                    value: function () {
                        var n = this.a.parentNode.cloneNode(), t, i, r;
                        return n.style.visibility = "hidden",
                            document.body.appendChild(n),
                            t = this.k.cloneNode(),
                            n.appendChild(t),
                            i = this.selectedFlag.cloneNode(!0),
                            t.appendChild(i),
                            r = i.offsetWidth,
                    ...
                    key: "_0",
                    value: function () {
                        var i = "aggressive" === this.d.autoPlaceholder || !this.e && "polite" === this.d.autoPlaceholder, t, n;
                        window.intlTelInputUtils && i && (t = intlTelInputUtils.numberType[this.d.placeholderNumberType],
                            n = this.s.iso2 ? intlTelInputUtils.getExampleNumber(this.s.iso2, this.d.nationalMode, t) : "",
                            n = this._7(n),
                            "function" == typeof this.d.customPlaceholder && (n = this.d.customPlaceholder(n, this.s)),
                            this.a.setAttribute("placeholder", n))
                    }
                }, {
                    key: "_1",
                    value: function (n) {
                        var i = this._z(n.getAttribute("data-country-code")), t;
                        this._2();
                        this._4(n.getAttribute("data-dial-code"));
                        this.a.focus();
                    ...
                    key: "_3",
                    value: function (n, t) {
                        var i = this.m, s = window.pageYOffset || document.documentElement.scrollTop, u = i.offsetHeight, f = i.getBoundingClientRect().top + s, l = f + u, e = n.offsetHeight, o = n.getBoundingClientRect().top + s, a = o + e, r = o - f + i.scrollTop, h = u / 2 - e / 2, c;
                        o < f ? (t && (r -= h),
                            i.scrollTop = r) : a > l && (t && (r += h),
                                c = u - e,
                                i.scrollTop = r - c)
                    }
                }, {
                    key: "_4",
                    value: function (n) {
                        var i, t = this.a.value, r = "+".concat(n), u;
                        "+" === t.charAt(0) ? (u = this._5(t),
                            i = u ? t.replace(u, r) : r,
                            this.a.value = i) : this.d.autoInsertDialCode && (i = t ? r + t : r,
                                this.a.value = i)
                    }
                }, {
                    key: "_5",
                    ...
                    value: function (n) {
                        var i = n, t, r;
                        return this.d.separateDialCode && (t = this._5(i),
                            t && (t = "+".concat(this.s.dialCode),
                                r = " " === i[t.length] || "-" === i[t.length] ? t.length + 1 : t.length,
                                i = i.substr(r))),
                            this._j2(i)
                    }
                }, {
                    ...
                    key: "destroy",
                    value: function () {
                        var t = this.a.form, i, n;
                        this.d.allowDropdown && (this._2(),
                        ...
                        this.d.autoInsertDialCode && (t && t.removeEventListener("submit", this._a8),
                    ...
                    value: function (n) {
                        if (window.intlTelInputUtils) {
                            var t = this.s.iso2;
                            return intlTelInputUtils.formatNumber(this._6(), t, n)
                        }
                        return ""
                    }
                }, {
                    ...
                    value: function () {
                        if (window.intlTelInputUtils) {
                            var n = this.s.iso2;
                            return intlTelInputUtils.getValidationError(this._6(), n)
                        }
                        return -99
                    }
                }, {
                    ...
                    value: function () {
                        var n = this._6().trim();
                        return window.intlTelInputUtils ? intlTelInputUtils.isValidNumber(n, this.s.iso2) : null
                    }
                }, {
                    key: "setCountry",
                    value: function (n) {
                        var t = n.toLowerCase();
                        this.s.iso2 !== t && (this._z(t),
        ...
        return r.getCountryData = function () {
            return t
        }
            ,
            o = function (n, t, i) {
            ...
            function (n, t) {
                var i = new k(n, t);
                return i._init(),
                    n.setAttribute("data-intl-tel-input-id", i.id),
...
var isSmall = !1
    , onScroll = function () {
        $(window).scrollTop() > 50 ? isSmall || ($(".header-container").addClass("sticky-top"),
            isSmall = !0) : isSmall && ($(".header-container").removeClass("sticky-top"),
                isSmall = !1)
    }
    , totalWidth = 0;
...
!function (n) {
    ...
    typeof ko != "undefined" && ko.bindingHandlers && !ko.bindingHandlers.multiselect && (ko.bindingHandlers.multiselect = {
        ...
        init: function (t, i, r) {
            var u = n(t), s = ko.toJS(i()), f, e, o;
            u.multiselect(s);
            r.has("options") && (f = r.get("options"),
                ko.isObservable(f) && ko.computed({
                    read: function () {
                        f();
                        setTimeout(function () {
            ...
            r.has("value") && (e = r.get("value"),
                ko.isObservable(e) && ko.computed({
                    read: function () {
                        e();
                        setTimeout(function () {
            ...
            r.has("selectedOptions") && (o = r.get("selectedOptions"),
    ...
    t.prototype = {
        defaults: {
            buttonText: function (t, i) {
                if (this.allSelectedText && (t.length === n("option", n(i)).length || t.length === 0 && this.isNoneAll) && (n("option", n(i)).length !== 1 || this.isNoneAll) && this.multiple)
                    return this.selectAllNumber ? this.allSelectedText + " (" + (this.isNoneAll ? n("option", n(i)).length : t.length) + ")" : this.allSelectedText;
                if (t.length === 0)
                    return this.nonSelectedText;
                if (t.length > this.numberDisplayed)
            ...
            templates: {
                ...
                liGroup: '<li class="multiselect-item multiselect-group"><a tabindex="0"><label><\/label><\/a><\/li>'
            }
        },
        constructor: t,
        ...
        buildDropdown: function () {
            var i, t;
            if (this.$ul = n(this.options.templates.ul),
                ...
                i = this.$select.find("option").length >= (this.options.multiple ? 10 : 15),
                this.options.multiple || i) {
                if (t = '<li class="multiselect-selectbuttons disabled"><div>',
                    i && (t += '<input class="form-control input-sm multiselect-filter" type="text" placeholder="Filter..." />'),
                    this.options.multiple && !this.options.disableSelectAllAndClearOption && (t += '<a class="btn btn-sm btn-default multiselect-selectall"><i class="fa fa-check-square-o"><\/i> Select<\/a><a class="btn btn-sm btn-default multiselect-clear"><i class="fa fa-ban"><\/i> Clear<\/a>'),
                    t += "<\/div><\/li>",
                    n("ul", this.$container).append(t),
                    n("ul", this.$container).append(n('<li class="multiselect-nomatch disabled" style="display:none"><a><label>No matching items...<\/label><\/a><\/li>')),
                    this.options.isNoneAll)
                    this.$container.on("hide.bs.dropdown", n.proxy(function () {
                        n("option", this.$select).length === n("option:checked", this.$select).length && this.clearSelection()
                    }, this));
                this.$container.on("shown.bs.dropdown", n.proxy(function () {
                    n("input.multiselect-filter", this.$container).val("").focus();
                    n(".multiselect-container", this.$container).css("min-width", n(".multiselect-container", this.$container).width() + "px")
                }, this));
                this.$container.on("hide.bs.dropdown", n.proxy(function () {
                    n("input.multiselect-filter", this.$container).val("");
                    this.$container[0].querySelectorAll("li:not(.divider):not(.disabled)").forEach(function (n) {
                        n.style.display = "";
                        n.classList.remove("filter-hidden")
                    })
                }, this));
                if (i) {
                    n("input.multiselect-filter", this.$container).off("keydown.multiselect").on("keydown.multiselect", n.proxy(function (t) {
                        t.keyCode === 27 && this.$container.hasClass("open") ? (this.$button.click(),
                            t.stopPropagation(),
                            t.preventDefault()) : t.keyCode === 40 ? (n(this.$container).find("li:not(.divider):not(.disabled) a").filter(":visible").first().focus(),
                                t.stopPropagation(),
                                t.preventDefault()) : t.keyCode == 13 && (t.stopPropagation(),
                                    t.preventDefault())
                    }, this));
                    n("input.multiselect-filter", this.$container).off("input").on("input", n.proxy(function () {
                        var u = n("input.multiselect-filter", this.$container).val().trim()
                            , i = null;
                        u.length && (i = new RegExp(u, "i"));
                        var t = null
                            , f = !1
                            , r = !1
                            , e = !1;
                        this.$container[0].querySelectorAll("li:not(.divider):not(.disabled)").forEach(function (n) {
                            var u = i == null || i.test(n.textContent);
                            n.classList.contains("multiselect-group") ? (t = n,
                                f = u,
                                r = !1) : u && t != null && !r ? (t.style.display = "",
                                    t.classList.remove("filter-hidden"),
                                    r = !0) : f && (u = !0);
                            n.style.display = u ? "" : "none";
                            n.classList.toggle("filter-hidden", !u);
                            u && (e = !0)
                        });
                        n(".multiselect-nomatch", this.$container).toggle(!e)
                    }, this));
                    n("input.multiselect-filter", this.$container).off("focus").on("focus", n.proxy(function () {
                        n("input.multiselect-filter", this.$container).select()
                    }, this))
                }
            }
        },
        buildDropdownOptions: function () {
            ...
            n("li input", this.$ul).on("change", n.proxy(function (t) {
                var i = n(t.target)
                    , u = i.prop("checked") || !1
                    , f = i.val() === this.options.selectAllValue;
                if (i.prop("type") != "text") {
                    ...
                    var s = i.val()
                        ...
                        , e = n("option", this.$select).not(r)
                        , o = n("input", this.$container).not(i);
                    f && (u ? this.selectAll() : this.deselectAll());
                    f || (u ? (r.prop("selected", !0),
                        this.options.multiple ? r.prop("selected", !0) : (this.options.selectedClass && n(o).closest("li").removeClass(this.options.selectedClass),
                            n(o).prop("checked", !1),
                            e.prop("selected", !1),
                            this.$button.click()),
                        this.options.selectedClass === "active" && e.closest("a").css("outline", "")) : r.prop("selected", !1));
                    this.$select.change();
                    this.updateButtonText();
                    this.updateSelectAll();
            ...
            n("ul li a.multiselect-selectall", this.$container).on("click", n.proxy(function () {
                this.$container.find("li:not(.filter-hidden)").each(function (n, t) {
                    t.optionEl && t.optionEl.prop("selected", !0)
                });
                this.refresh();
                this.$select.change();
                this.options.onSelectAll()
            }, this));
            n("ul li a.multiselect-clear", this.$container).on("click", n.proxy(function () {
                this.$container.find("li:not(.filter-hidden)").each(function (n, t) {
                    t.optionEl && t.optionEl.prop("selected", !1)
                });
                this.refresh();
                this.$select.change();
            ...
            n("li a", this.$ul).on("touchstart click", n.proxy(function (t) {
                var i = n(t.target), e, u, r, s, f, o, h, c, l;
                if (!i.parents(".multiselect-group").length) {
                    if (t.stopPropagation(),
                        t.shiftKey && this.options.multiple) {
                        if (i.is("label") && (t.preventDefault(),
                            i = i.find("input"),
                            i.prop("checked", !i.prop("checked"))),
                            e = i.prop("checked") || !1,
                            this.lastToggledInput !== null && this.lastToggledInput !== i)
                            for (u = i.closest("li").index(),
                                r = this.lastToggledInput.closest("li").index(),
                                u > r && (s = r,
                                    r = u,
                                    u = s),
                                ++r,
                                f = this.$ul.find("li").slice(u, r).filter(":visible").find("input"),
                                f.prop("checked", e),
                                this.options.selectedClass && f.closest("li").toggleClass(this.options.selectedClass, e),
                                o = 0,
                                h = f.length; o < h; o++)
                                c = n(f[o]),
                                    l = this.getOptionByValue(c.val()),
                                    l.prop("selected", e);
                        i.trigger("change")
                    }
            ...
            this.$container.off("keydown.multiselect").on("keydown.multiselect", n.proxy(function (t) {
                ...
                if (!n('input[type="text"]', this.$container).is(":focus"))
                    if (t.keyCode === 9 && this.$container.hasClass("open"))
                        ...
                        if (r = n(this.$container).find("li:not(.divider):not(.disabled) a").filter(":visible"),
                            !r.length)
                            return;
                        if (i = r.index(r.filter(":focus")),
                            t.keyCode === 38)
                            if (i == 0) {
                                if (n("input.multiselect-filter", this.$container).length) {
                                    n("input.multiselect-filter", this.$container).focus();
                                    t.stopPropagation();
                                    t.preventDefault();
                                    return
                                }
                            ...
                            t.keyCode === 40 ? i < r.length - 1 ? i++ : i = 0 : ~i || (i = 0);
                        u = r.eq(i);
                        u.focus();
                        (t.keyCode === 32 || t.keyCode === 13) && (e = u.closest(".multiselect-group"),
                            e.length ? e.click() : (f = u.find("input"),
            ...
            if (this.options.enableClickableOptGroups && this.options.multiple)
                n("li.multiselect-group", this.$ul).on("click", n.proxy(function (t) {
                    t.stopPropagation();
                    var u = n(t.target).closest(".multiselect-group")
                        , f = u.nextUntil("li.multiselect-group")
                        , r = f.filter(":visible:not(.disabled)")
                        , i = !0
                        , e = r.find("input");
                    e.each(function () {
                        i = i && n(this).prop("checked")
                    });
                    r.each(function (n, t) {
                        t.optionEl && t.optionEl.prop("selected", !i)
                    });
                    this.refresh();
                    this.$select.change()
                }, this))
        ...
        createOptionValue: function (t) {
            ...
            this.options.optionClass && (e = this.options.optionClass(i),
                e && f.addClass(e));
            u = n("label", f);
            u.addClass(c);
            this.options.enableHTML ? u.html(" " + s) : u.text(" " + s);
            r = n("<input/>").attr("type", c);
            this.options.checkboxName && r.attr("name", this.options.checkboxName);
            u.prepend(r);
            o = i.prop("selected") || !1;
            r.val(h);
            h === this.options.selectAllValue && (f.addClass("multiselect-item multiselect-all"),
                r.parent().parent().addClass("multiselect-all"));
            u.attr("title", i.attr("title"));
            this.$ul.append(f);
            f[0].optionEl = i;
            i.is(":disabled") && r.attr("disabled", "disabled").prop("disabled", !0).closest("a").attr("tabindex", "-1").closest("li").addClass("disabled");
            r.prop("checked", o);
            o && this.options.selectedClass && r.closest("li").addClass(this.options.selectedClass)
        },
        ...
        createOptgroup: function (t) {
            var r = n(t).prop("label")
                , i = n(this.options.templates.liGroup);
            i.data("source-optgroup", t);
            this.options.enableHTML ? n("label", i).html(r) : n("label", i).text(r);
        ...
        buildSelectAll: function () {
            ...
            r = this.hasSelectAll();
            !r && this.options.includeSelectAllOption && this.options.multiple && n("option", this.$select).length > this.options.includeSelectAllIfMoreThan && (this.options.includeSelectAllDivider && this.$ul.prepend(n(this.options.templates.divider)),
                t = n(this.options.templates.li),
                n("label", t).addClass("checkbox"),
                this.options.enableHTML ? n("label", t).html(" " + this.options.selectAllText) : n("label", t).text(" " + this.options.selectAllText),
                this.options.selectAllName ? n("label", t).prepend('<input type="checkbox" name="' + this.options.selectAllName + '" />') : n("label", t).prepend('<input type="checkbox" />'),
                i = n("input", t),
        ...
        buildFilter: function () {
            var i, t;
            if ((this.options.enableFiltering || this.options.enableCaseInsensitiveFiltering) && (i = Math.max(this.options.enableFiltering, this.options.enableCaseInsensitiveFiltering),
                this.$select.find("option").length >= i)) {
                if (this.$filter = n(this.options.templates.filter),
                    n("input", this.$filter).attr("placeholder", this.options.filterPlaceholder),
                    this.options.includeFilterClearBtn) {
                    t = n(this.options.templates.filterClearBtn);
                    t.on("click", n.proxy(function () {
                        clearTimeout(this.searchTimeout);
                        this.$filter.find(".multiselect-search").val("");
                        n("li", this.$ul).show().removeClass("filter-hidden");
                        this.updateSelectAll()
                    }, this));
                    ...
                    this.searchTimeout = this.asyncFunction(n.proxy(function () {
                        if (this.query !== t.target.value) {
                            ...
                            n.each(n("li", this.$ul), n.proxy(function (t, u) {
                                var o = n("input", u).length > 0 ? n("input", u).val() : "", s = n("label", u).text(), e = "", f;
                                this.options.filterBehavior === "text" ? e = s : this.options.filterBehavior === "value" ? e = o : this.options.filterBehavior === "both" && (e = s + "\n" + o);
                                o !== this.options.selectAllValue && s && (f = !1,
                                    this.options.enableCaseInsensitiveFiltering && e.toLowerCase().indexOf(this.query.toLowerCase()) > -1 ? f = !0 : e.indexOf(this.query) > -1 && (f = !0),
                                    n(u).toggle(f).toggleClass("filter-hidden", !f),
                                    n(u).hasClass("multiselect-group") ? (i = u,
                                        r = f) : (f && n(i).show().removeClass("filter-hidden"),
                                            !f && r && n(u).show().removeClass("filter-hidden")))
                            }, this))
                        }
                        this.updateSelectAll()
                    }, this), 300, this)
        ...
        refresh: function () {
            n("option", this.$select).each(n.proxy(function (t, i) {
                var r = n("li input[value='" + n(i).val() + "']", this.$ul);
                n(i).is(":selected") ? (r.prop("checked", !0),
                ...
                n(i).is(":disabled") ? r.attr("disabled", "disabled").prop("disabled", !0).closest("li").addClass("disabled") : r.prop("disabled", !1).closest("li").removeClass("disabled")
            }, this));
            this.updateButtonText();
            this.updateSelectAll()
        },
        select: function (t, i) {
            ...
            for (n.isArray(t) || (t = [t]),
                u = 0; u < t.length; u++)
                if ((r = t[u],
                    r !== null && r !== undefined) && (f = this.getOptionByValue(r),
                        e = this.getInputByValue(r),
                        f !== undefined && e !== undefined) && (this.options.multiple || this.deselectAll(!1),
                            this.options.selectedClass && e.closest("li").addClass(this.options.selectedClass),
                            e.prop("checked", !0),
                            f.prop("selected", !0),
                            i))
                    this.options.onChange(f, !0);
            this.updateButtonText();
            this.updateSelectAll()
        },
        ...
        deselect: function (t, i) {
            ...
            for (n.isArray(t) || (t = [t]),
                ...
                if ((r = t[u],
                    r !== null && r !== undefined) && (f = this.getOptionByValue(r),
                        e = this.getInputByValue(r),
                        f !== undefined && e !== undefined) && (this.options.selectedClass && e.closest("li").removeClass(this.options.selectedClass),
                            e.prop("checked", !1),
                            f.prop("selected", !1),
                            i))
                    this.options.onChange(f, !1);
            this.updateButtonText();
            this.updateSelectAll()
        },
        selectAll: function (t, i) {
            var t = typeof t == "undefined" ? !0 : t, r = n("li input[type='checkbox']:enabled", this.$ul), u = r.filter(":visible"), e = r.length, o = u.length, f;
            t ? (u.prop("checked", !0),
                n("li:not(.divider):not(.disabled)", this.$ul).filter(":visible").addClass(this.options.selectedClass)) : (r.prop("checked", !0),
                    n("li:not(.divider):not(.disabled)", this.$ul).addClass(this.options.selectedClass));
            e === o || t === !1 ? n("option:enabled", this.$select).prop("selected", !0) : (f = u.map(function () {
                return n(this).val()
            }).get(),
                n("option:enabled", this.$select).filter(function () {
                    return n.inArray(n(this).val(), f) !== -1
                }).prop("selected", !0));
            i && this.options.onSelectAll()
        },
        deselectAll: function (t) {
            var t = typeof t == "undefined" ? !0 : t, i, r;
            t ? (i = n("li input[type='checkbox']:not(:disabled)", this.$ul).filter(":visible"),
                i.prop("checked", !1),
                r = i.map(function () {
                    return n(this).val()
                }).get(),
                n("option:enabled", this.$select).filter(function () {
                    return n.inArray(n(this).val(), r) !== -1
                }).prop("selected", !1),
                this.options.selectedClass && n("li:not(.divider):not(.disabled)", this.$ul).filter(":visible").removeClass(this.options.selectedClass)) : (n("li input[type='checkbox']:enabled", this.$ul).prop("checked", !1),
                    n("option:enabled", this.$select).prop("selected", !1),
                    this.options.selectedClass && n("li:not(.divider):not(.disabled)", this.$ul).removeClass(this.options.selectedClass))
        },
        rebuild: function () {
            this.$ul.html("");
            this.options.multiple = this.$select.attr("multiple") === "multiple";
        ...
        dataprovider: function (t) {
            ...
            n.each(t, function (t, f) {
                var e;
                n.isArray(f.children) ? (r++,
                    e = n("<optgroup/>").attr({
                        label: f.label || "Group " + r,
                        disabled: !!f.disabled
                    }),
                    i(f.children, function (t) {
                        e.append(n("<option/>").attr({
                            value: t.value,
        ...
        updateSelectAll: function () {
            if (this.hasSelectAll()) {
                var i = n("li:not(.multiselect-item):not(.filter-hidden) input:enabled", this.$ul)
                    , f = i.length
                    , r = i.filter(":checked").length
                    , t = n("li.multiselect-all", this.$ul)
                    , u = t.find("input");
                r > 0 && r === f ? (u.prop("checked", !0),
                    t.addClass(this.options.selectedClass),
                    this.options.onSelectAll()) : (u.prop("checked", !1),
        ...
        getOptionByValue: function (t) {
            for (var r, u = n("option", this.$select), f = t.toString(), i = 0; i < u.length; i = i + 1)
                if (r = u[i],
                    r.value === f)
                    return n(r)
        },
        getInputByValue: function (t) {
            for (var r, u = n("li input", this.$ul), f = t.toString(), i = 0; i < u.length; i = i + 1)
                if (r = u[i],
                    r.value === f)
                    return n(r)
        },
    ...
    n.fn.multiselect = function (i, r, u) {
        return this.each(function () {
            var f = n(this).data("multiselect")
                , e = typeof i == "object" && i;
            f || (f = new t(this, e),
                n(this).data("multiselect", f));
            typeof i == "string" && (f[i](r, u),
                i === "destroy" && n(this).data("multiselect", !1))
        })
    }
        ;
